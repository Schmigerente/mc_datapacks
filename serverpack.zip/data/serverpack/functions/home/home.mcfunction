...
execute as @s at @s store result entity @e[type=armor_stand,limit=1,tag=reset] Pos[0] double 1 run scoreboard players get @p x_home
execute as @s at @s store result entity @e[type=armor_stand,limit=1,tag=reset] Pos[1] double 1 run scoreboard players get @p y_home
execute as @s at @s store result entity @e[type=armor_stand,limit=1,tag=reset] Pos[2] double 1 run scoreboard players get @p z_home
execute as @s at @s store result entity @e[type=armor_stand,limit=1,tag=reset] Rotation[0] float 1 run scoreboard players get @p r_home
execute as @s at @s store result entity @e[type=armor_stand,limit=1,tag=reset] Rotation[1] float 1 run scoreboard players get @p l_home
